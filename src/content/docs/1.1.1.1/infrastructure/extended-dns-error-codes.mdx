...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            This error indicates that the DNS resolver could only return stale data. If the issue persists reach out on the 1.1.1.1 <a href="https://community.cloudflare.com/c/reliability/dns-1111/47">community forum</a>.
        </tr>
        <tr>
            <td>6</td>
            <td>DNSSEC Bogus</td>
